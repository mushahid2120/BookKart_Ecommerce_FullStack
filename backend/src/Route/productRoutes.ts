...
import { createProduct, deleteProduct, getAllProduct, getLatestProduct, getProductById, getProductBySellerId } from "../Controller/productController.js";
...
productRouter.get("/latest-product",getLatestProduct);
