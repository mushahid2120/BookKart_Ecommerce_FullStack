...
const cartPersistConfig = {
  key: "cart",
  storage,
  whitelist: ["product", "checkoutStatus"],
};
...
const persistedWishlistReducer = persistReducer(
  ...
  wishlistSlice,
); // what to store and from where
const persistedCartReducer = persistReducer(cartPersistConfig, cartSlice); // what to store and from where
const persistedOrderReducer = persistReducer(orderPersistConfig, orderSlice); // what to store and from where
