  ...
  return (
    <div className="min-h-screen bg-gray-100 py-16">
      <div className="container mx-auto px-4">
        ...
        {/* Images Section */}
        <div className="mt-16 flex flex-col justify-center items-center md:flex-row gap-6 items-center mb-4">
          <img
            src="/Image/Hero1.jpg"
            alt="Books"
            className="w-full md:w-[300px] rounded-lg shadow-md mb-4 md:mb-0"
          />
          <img
            src="/Image/Hero2.jpg"
            alt="Reading"
            className="w-full md:w-[300px] rounded-lg shadow-md"
          />
        </div>
        <h2 className="text-xl font-semibold text-center mb-4">
          Join Us Today!
